  ...
  career:[
    ...
    {src:'real',         ti:'🧱 Le Serveur Minecraft du Schloss', tx:"Une adresse IP. Un mot de passe sur un Post-it.\nLe serveur Minecraft du Schloss.\n\nOn a reconstruit le lycée De Gaulle bloc par bloc.\nCouloirs, salles de classe, le CDI.\nEt puis on s\'est mis à se coller dessus avec des épées en fer.\n\nLes premiers mini-jeux du Schloss sont nés là.\nFlint and Steel. D\'autres maps. D\'autres nuits.\n\nPersonne ne dormait pendant les vacances.\nPersonne ne le regrettait.",
      ...
      extra:{
        ...
        clement:[{t:'b',v:7,l:'💍 Clément : +7 bonheur (il a construit une maison impeccable — et l\'a habitée jusqu\'au bout)'}],
        don:[{t:'b',v:6,l:'🎩 Don : +6 bonheur (il était là — il a grillé le spawn à plusieurs reprises)'}],
        existless:[{t:'b',v:6,l:'🌑 Existless : +6 bonheur (il creusait en silence — et réapparaissait avec des diamants)'}],
        ptitcuicui:[{t:'b',v:5,l:'🐦 Ptitcuicui : +5 bonheur (l\'architecte du serveur — mais les maps prenaient du temps)'}],
        avarod:[{t:'b',v:4,l:'🦊 Avarod : +4 bonheur (il a entendu parler du serveur — il aurait adoré y être)'}],
        invoherence:[{t:'b',v:4,l:'🐰 Incoherence : +4 bonheur (elle a vu les screenshots — ça avait l\'air fun)'}],
      }
    },
  ],
};
...
const PLAYER_DEFS = [
  ...
  {id:'don',         name:'Don',          emoji:'🎩', color:'#e74c3c', bg:'#2d0a0a', role:'Le Chauffeur Imprévisible',   stats:{gaming:7,finance:7,chance:7,social:9}},
  {id:'avarod',      name:'Avarod',       emoji:'🦊', color:'#00d4aa', bg:'#002d27', role:'Le Camarade Supinfo',         stats:{gaming:9,finance:7,chance:6,social:8}},
  {id:'guigeek',     name:'Guigeek',      emoji:'🤓', color:'#2ecc71', bg:'#0a2d15', role:'Le Geek Solitaire',           stats:{gaming:9,finance:7,chance:8,social:6}},
  {id:'existless',   name:'Existless',    emoji:'🌑', color:'#6c5ce7', bg:'#1a0d3a', role:'Le Fantôme du Schloss',       stats:{gaming:8,finance:7,chance:9,social:6}},
  {id:'clement',     name:'Clément',      emoji:'💍', color:'#f39c12', bg:'#2d1f00', role:"L'Époux de Marie-Ange",       stats:{gaming:5,finance:8,chance:8,social:9}},
